...
if (workerData.id_transaksi!='') {
    let setnewdata = `UPDATE admlistdata SET status='${workerData.data.status}', history='${workerData.data.history}', diterima_konsumen='true' WHERE BINARY id_transaksi='${workerData.data.id_transaksi}'`;
