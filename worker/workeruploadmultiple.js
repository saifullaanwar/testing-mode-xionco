...
(async () => { // Menggunakan async IIFE agar bisa menggunakan await di top-level
    try {
        ...
        const { saveorupload, images } = workerData;
        ...
        for (const image of images) {
            ...
            const baseUploadDir = './assets/pridukimage/'; // Folder dasar Anda
            ...
            uploadedFilesInfo.push({
                ...
                path: filePath,
                url: `/assets/pridukimage/${filenameToSave}` // URL yang dapat diakses publik
            });
        }
