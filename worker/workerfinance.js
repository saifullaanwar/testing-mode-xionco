...
async function sharpsc() {
    if (workerData.saveorupload=='uploadimage') {
        try {
            ...
            const folderPath = './assets/bank-limbo/'+folderyear;
    ...
    }else if (workerData.saveorupload=='uploadimage-bankinvestor') {
        try {
            console.log('2');
            ...
            const folderPath = './assets/bank-investor/'+folderyear;
    ...
    }else if (workerData.saveorupload=='uploadimage-vendorreceipt') {
        try {
            console.log('2');
            ...
            const folderPath = './assets/vendorreceipt/'+folderyear;
    ...
    if (workerData.saveorupload=='uploadimage_drafplaninvestor') {
        try {
            console.log('2');
            ...
            const folderPath = './assets/draf_plan_investor/'+folderyear;
