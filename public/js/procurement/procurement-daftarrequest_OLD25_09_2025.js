...
function returnarray(array,prosedur) {
    ...
    return fixarraawal.map(function(element){
        var tableapprovalhide='class="d-none"';
        if (gethumburger.tipeuser.toLowerCase()=='supervisor'||gethumburger.tipeuser.toLowerCase()=='procurement') {
            tableapprovalhide='class="d-none"';
        }
        return `
            <tr>
                ...
                <td style="text-align: left;" ${tableapprovalhide}>
                    <span class="badge text-bg-secondary" style="cursor: pointer;">Approval</span>
                </td>
